...
for line in sys.stdin:
    ...
    if bin_name not in opened_bins:
        ...
        files[sys.argv[2] + "/" + bin_name + ".nanopore.fastq"] = open(
            sys.argv[2] + "/" + bin_name + ".nanopore.fastq", "w"
        )
    ...
    # strict assembly
    files[sys.argv[2] + "/" + bin_name + ".nanopore.fastq"].write(
        "@" + cut[0] + "/1" + "\n" + cut[9] + "\n+\n" + cut[10] + "\n"
    )
